...
class Remplisseur{
    ...
    public function fullDisplay($raison = null){
        ...
        echo '<em><b>Chers Parents, nous vous souhaitons la bienvenue sur le site de l\'Apel (Association des Parents d\'élèves de l\'Enseignement Libre) de l\'Institution Champagnat. <br>
        ...
        echo '<br><br><em>Un problème, une question ? Contactez nous par mail à apel@champagnat.org</em>';
    }
