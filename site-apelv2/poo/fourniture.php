<?php
/** Romain ANGIER */
class Fourniture extends Element {

    public static function SQLInsert(){
        return 'INSERT INTO fourniture (FOUCode, FOUCodeCAT, FOULibelle, FOUPrixU, FOUQuantite)
							VALUES (?,?,?,?,?)';
    }
    public static function SQLUpdate() {
        return 'UPDATE fourniture
				SET FOUCode = ?,
				FOUCodeCAT = ?,
				FOULibelle = ?,
				FOUPrixU = ?,
...
class Fournitures extends Elements {
